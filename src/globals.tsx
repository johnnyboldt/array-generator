...
export class Globals {
    ...
    public static readonly SHUFFLEDARRAY_ROOT_URL = `https://localhost:${Globals.PORT}/api/ShuffledArray/`;
    public static readonly SORTEDARRAY_ROOT_URL = `https://localhost:${Globals.PORT}/api/SortedArray/`;
    ...
    // Errors
    public static readonly MinGreaterThanMaxError = "Minimum Number can not be greater than Maximum Number.";
    public static readonly MinLessThanAllowed = `Minimum Number can not be less than ${Globals.minimumAllowableNumber}.`;
    public static readonly MaxGreaterThanAllowed = `Maximum Number can not be greater than ${Globals.maximumAllowableNumber}.`;
}
